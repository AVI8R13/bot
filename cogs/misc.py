...
class Misc(commands.Cog):
    ...
    async def eightball(self, ctx, *question):
        ...
        eigthballEmbed = discord.Embed(
            title = f"Eight ball :eight_ball:"
        )
        eightballEmbed.add_field(name=question, value = response, inline = True)
        await ctx.send(embed=eigthballEmbed)
